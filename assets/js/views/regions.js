window.countries = {
	...
	"Australia": ["Australian Capital Territory", "Jervis Bay Territory", "New South Wales", "Northern Territory", "Queensland", "South Australia", "Tasmania", "Victoria", "Western Australia"],
	...
	"Moldova, Republic of": ["Balti", "Cahul", "Chisinau", "Chisinau", "Dubasari", "Edinet", "Gagauzia", "Lapusna", "Orhei", "Soroca", "Tighina", "Ungheni"],
	...
	"Serbia": ["Backa North District", "Central Banat District", "North Banat District", "South Banat District", "West Backa District", "Backa South District", "Srem District", "Macva District", "Kolubara District", "Podunavlje District", "Branicevo District", "Sumadija District", "Pomoravlje District", "Bor District", "Zajecar District", "Zlatibor District", "Morava District", "Raska District", "Rasina District", "Nisava District", "Toplica District", "Pirot District", "Jablanica District", "Pcinja District", "Kosovo District", "Pec District", "Prizren District", "Kosovska Mitrovica District", "Kosovsko Pomoravlje District"],
...
$(document).ready(function () {
	...
	// Now that it's loaded, we can trigger on changes.
	c.change(updateStateSelect);
...
function updateStateSelect() {
	...
	if (!state.data("current")) {
		...
		// Does it exist in our list of states?
		var validstate = false;
		$.each(window.countries[newcountry], function (i, v) {
			if (thisstate === v) {
				validstate = true;
				return false;
			}
		...
		// Did we find it?
		if (validstate) {
			// Awesome. It can be first.
			state.append("<option>" + thisstate + "</option>");
		} else {
			// Ah. It's not valid.
			thisstate = false;
			state.append("<option other=true>"+selectstate+"</option>");
	...
	// Add any states, excluding thisstate
	$.each(window.countries[newcountry], function (i, v) {
		if (thisstate !== v) {
